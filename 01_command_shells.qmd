...
usage: man [-k] command...
```
Note that for the most of the "builtin" commands shown above, there might
...
> Note: Make sure there is no other `PROMPT=` assignment in your `.zshrc` file
> other than the one we added above.
